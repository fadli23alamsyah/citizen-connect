...
export default async function Home() {
  return (
    <main className="flex flex-col pb-5 gap-2 px-3 mb-16 md:mb-0">
      <Filter />
      <h1 className="font-bold font-mono text-3xl md:text-6xl text-sky-400 tracking-wider text-center">Event Citizen</h1>
      ...
      <section className="grid grid-cols-1 gap-3 md:gap-5 md:grid-cols-3 mt-8 md:px-32">
